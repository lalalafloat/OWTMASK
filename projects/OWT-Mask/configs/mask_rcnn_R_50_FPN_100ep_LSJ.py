...
from configs.common.data.coco import dataloader
# from configs.common.models.mask_rcnn_fpn import model
from .mask_rcnn_fpn import model
from configs.common.optim import SGD as optimizer
from configs.common.train import train
# from detectron2.projects.owtmask.models import ReidStandardROIHeads, ReidFastRCNNOutputLayers

# train from scratch
train.init_checkpoint = "pretrained/model_final_f96b26.pkl"
...
model.backbone.bottom_up.stem.norm = \
    ...
    # model.backbone.norm = "SyncBN"  # [ATTN] 单卡时候只能用BN 多卡才能syncbn
