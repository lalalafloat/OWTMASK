...
from .seqstao import register_seqstao_instances
from detectron2.data.datasets.builtin_meta import _get_coco_agn_instances_meta
...
_PREDEFINED_SPLITS_YTVIS_TAO = {
    # "ytvis_tao_train": ("tao/frames", "tao/annotations/tao_train_coco_1.json"),
    "ytvis_tao_val": ("tao/frames", "tao/annotations/validation_agn.json"),

    # "ytvis_tao_val": ("tao/frames", "tao/annotations/validation_1.json"),
}


def register_all_seqstao(root):
    for key, (image_root, json_file) in _PREDEFINED_SPLITS_YTVIS_TAO.items():
        # Assume pre-defined datasets live in `./datasets`.
        # print('key = {}'.format(key))
        register_seqstao_instances(
            key,
            _get_coco_agn_instances_meta(),
