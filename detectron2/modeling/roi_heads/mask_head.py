...
def mask_rcnn_inference(pred_mask_logits: torch.Tensor, pred_instances: List[Instances]):
    ...
    if cls_agnostic_mask:
        ...
        mask_probs_pred = pred_mask_logits[indices, class_pred][:, None].sigmoid()  # [ATTN]  已经sigmoid过了 后续tracker里面不用sigmoid了
...
class MaskRCNNConvUpsampleHead(BaseMaskRCNNHead, nn.Sequential):  # [ATTN]
    """
