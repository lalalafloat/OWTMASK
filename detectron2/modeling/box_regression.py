...
def _dense_box_regression_loss(
    ...
    if isinstance(anchors[0], Boxes):
        ...
        anchors = cat(anchors)
    # print('debug: train, anchors[0] = {}, gt_boxes[0] = {}'.format(anchors[0], gt_boxes[0][0]))
    # debug: train, anchors[0] = tensor([-22.6274, -11.3137,  22.6274,  11.3137], device='cuda:0'), gt_boxes[0] = tensor([210.0246,  49.6129, 472.9615, 516.0335], device='cuda:0')
    # 上面是原始的rpn的数据流的输入，可见的确是没有归一化的
